...
\begin{itemize}
	\item    Le mot clé \texttt{elif} doit être au même niveau d'indentation que l'instruction if qu'elle complète.
	\item    \texttt{elif} doit également être suivi d'une condition et de deux points (\texttt{:}).
	\item  L'instruction else ne peut figurer qu'une seule fois en clôture du bloc de la condition if.
\end{itemize}
